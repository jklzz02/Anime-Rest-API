    ...
    public static List<Anime> GetMockAnimeList()
    {
        ...
        [
            new Anime
            {
                ...
                SourceId = 1,
                Release_Year = 2020,
                Started_Airing = new DateTime(2020, 1, 10),
                Finished_Airing = new DateTime(2020, 6, 20),
                Rating = "R",
                Studio = "Wit Studio",
                Score = 9.2m,
                Status = "Finished",
            ...
            new Anime
            {
                ...
                SourceId = 1,
                Release_Year = 2001,
                Started_Airing = new DateTime(2001, 7, 20),
                Finished_Airing = new DateTime(2001, 7, 20),
                Rating = "PG",
                Studio = "Ghibli",
                Score = 9.5m,
                Status = "Finished",
            ...
            new Anime
            {
                ...
                SourceId = 1,
                Release_Year = 2002,
                Started_Airing = new DateTime(2002, 10, 3),
                Finished_Airing = new DateTime(2007, 2, 8),
                Rating = "PG-13",
                Studio = "Pierrot",
                Score = 8.2m,
                Status = "Finished",
            ...
            new Anime
            {
                ...
                SourceId = 1,
                Release_Year = 2017,
                Started_Airing = new DateTime(2017, 7, 7),
                Finished_Airing = new DateTime(2017, 9, 29),
                Rating = "R",
            ...
            new Anime
            {
                ...
                SourceId = 1,
                Release_Year = 1985,
                Started_Airing = new DateTime(1985, 4, 1),
                Finished_Airing = new DateTime(1985, 7, 15),
                Rating = "PG",
                Studio = "OldStudio",
                Score = 7.0m,
                Status = "Finished",
